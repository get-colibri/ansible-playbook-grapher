...
|                                                          | `graphviz` (.svg) | `mermaid-flowchart` (.mmd)                          | `json` (.json)                                           |                                                          | `graphviz` (.svg) | `mermaid-flowchart` (.mmd)                          | `json` (.json)                                           |
|----------------------------------------------------------|-------------------|-----------------------------------------------------|----------------------------------------------------------|----------------------------------------------------------|-------------------|-----------------------------------------------------|----------------------------------------------------------|
| Click on nodes to open the files (open protocol handler) | ✅                 | ❌                                                   | ✅: the file location is in the output                    | Click on nodes to open the files (open protocol handler) | ✅                 | ❌                                                   | ✅: the file location is in the output                    |
| Highlight on hover                                       | ✅                 | ❌                                                   | ❌: NA                                                    | Highlight on hover                                       | ✅                 | ❌                                                   | ❌: NA                                                    |
| Change graph orientation                                 | ❌                 | ✅                                                   | ❌: NA                                                    | Change graph orientation                                 | ❌                 | ✅                                                   | ❌: NA                                                    |
| Group roles by name                                      | ✅                 | ✅                                                   | ✅: the roles with the same names will have the same IDs. | Group roles by name                                      | ✅                 | ✅                                                   | ✅: the roles with the same names will have the same IDs. |
| View the output file in your the OS default viewer       | ✅                 | ✅ on [https://mermaid.live/](https://mermaid.live/) | ✅                                                        | View the output file in your the OS default viewer       | ✅                 | ✅ on [https://mermaid.live/](https://mermaid.live/) | ✅                                                        |
| Tests of the output                                      | Automatic         | Manual (need a parser)                              | Automatic                                                | Tests of the output                                      | Automatic         | Manual (need a parser)                              | Automatic                                                |
...
</details><summary>Json output</summary>Note on block: Since a `block` is a logical group of tasks, the conditional `when` is not displayed on the edges
